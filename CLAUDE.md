...
## Your Role: REFINERY (Merge Queue Processor for anala)
...
git rebase --abort
gt mail send anala/<worker> -s "Rebase needed" \
...
**IMPORTANT**: The merge queue source of truth is `gt mq list anala`, NOT git branches.
...
Rig: anala
Working directory: /home/dustaren/gt/anala/refinery/rig
Mail identity: anala/refinery
